...
safeGND = digitalio.DigitalInOut(board.GP14) # safeGND = digitalio.DigitalInOut(board.GP7)
...
safe = digitalio.DigitalInOut(board.GP7) # safe = digitalio.DigitalInOut(board.GP14)  # <-- choose your button pin
